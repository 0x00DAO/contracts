...
export interface WelcomeEveryOneInterface extends utils.Interface {
  functions: {
...
export interface WelcomeEveryOne extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: WelcomeEveryOneInterface;
